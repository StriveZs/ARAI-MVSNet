...
def collect_dtu(args):
	...
	for scene in all_scenes:
		...
		all_plys = sorted(glob.glob('{}/points_arainet/consistencyCheck*'.format(scene)))
		print('Found points: ', all_plys)

		shutil.copyfile(all_plys[-1]+'/final3d_model.ply', '{}/arainet{:03d}_l3.ply'.format(args.target_dir, scene_id))
