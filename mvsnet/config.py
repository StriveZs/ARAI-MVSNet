...
_C.MODEL.WEIGHT = ""
_C.MODEL.CKPT = ""
_C.MODEL.NET_CONFIGS = ()
_C.MODEL.LAMB = 1.5
_C.MODEL.LOSS_WEIGHTS = ()
...
_C.SCHEDULER.FLOW1_EPOCH = 10
_C.SCHEDULER.FLOW2_EPOCH = 20
...
def load_cfg_from_file(cfg_filename):
    ...
    cfg_template = _C
    cfg_template.merge_from_other_cfg(cfg) # merge parameters
    return cfg_template
